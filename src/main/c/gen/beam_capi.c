 ...
 * File created at Sun Nov 11 17:15:40 CET 2012 using org.esa.beam.extapi.gen.ApiGeneratorDoclet
 */
...
int* Band_readPixelsInt(Band _self, int x, int y, int w, int h, int* pixelsElems, int pixelsLength, int* resultArrayLength)
{
    ...
    _resultArray = (*jenv)->CallObjectMethod(jenv, _self, _method, x, y, w, h, pixelsArray);
    _result = beam_alloc_int_array(_resultArray, resultArrayLength);
    beam_copy_from_jarray(pixelsArray, pixelsElems, pixelsLength, sizeof (int));
    if (_resultArray == pixelsArray) {
        _result = pixelsElems;
    }
    return _result;
}
...
float* Band_readPixelsFloat(Band _self, int x, int y, int w, int h, float* pixelsElems, int pixelsLength, int* resultArrayLength)
{
    ...
    _resultArray = (*jenv)->CallObjectMethod(jenv, _self, _method, x, y, w, h, pixelsArray);
    _result = beam_alloc_float_array(_resultArray, resultArrayLength);
    beam_copy_from_jarray(pixelsArray, pixelsElems, pixelsLength, sizeof (float));
    if (_resultArray == pixelsArray) {
        _result = pixelsElems;
    }
    return _result;
...
double* Band_readPixelsDouble(Band _self, int x, int y, int w, int h, double* pixelsElems, int pixelsLength, int* resultArrayLength)
{
    ...
    _resultArray = (*jenv)->CallObjectMethod(jenv, _self, _method, x, y, w, h, pixelsArray);
    _result = beam_alloc_double_array(_resultArray, resultArrayLength);
    beam_copy_from_jarray(pixelsArray, pixelsElems, pixelsLength, sizeof (double));
    if (_resultArray == pixelsArray) {
        _result = pixelsElems;
    }
    return _result;
