...
int beam_initApi()
{
    ...
    classGeometry = beam_findJvmClass("com/vividsolutions/jts/geom/Geometry");
    if (classGeometry == NULL) { 
        fprintf(stderr, "beam_capi: Java class not found: com/vividsolutions/jts/geom/Geometry\n");
        exitCode = 2082;
        return exitCode;
    }
...
ImageInfo ImageInfo_clone(ImageInfo _this)
{
    static jmethodID _method = NULL;
    ImageInfo _result = (ImageInfo) 0;
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classImageInfo, "clone", "()Lorg/esa/beam/framework/datamodel/ImageInfo;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
{
    static jmethodID _method = NULL;
    SubsetOp _result = (SubsetOp) 0;
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "<init>", "()V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    _result = (*jenv)->NewObject(jenv, classSubsetOp, _method);
    return _result != NULL ? (*jenv)->NewGlobalRef(jenv, _result) : NULL;
}
...
char** SubsetOp_getTiePointGridNames(SubsetOp _this, int* _resultArrayLength)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getTiePointGridNames", "()[Ljava/lang/String;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
{
    static jmethodID _method = NULL;
    jobjectArray tiePointGridNamesArray = NULL;
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setTiePointGridNames", "([Ljava/lang/String;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    tiePointGridNamesArray = beam_newJStringArray(tiePointGridNamesElems, tiePointGridNamesLength);
    (*jenv)->CallVoidMethod(jenv, _this, _method, tiePointGridNamesArray);
    (*jenv)->DeleteLocalRef(jenv, tiePointGridNamesArray);
}
...
char** SubsetOp_getBandNames(SubsetOp _this, int* _resultArrayLength)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getBandNames", "()[Ljava/lang/String;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setBandNames(SubsetOp _this, const char** bandNamesElems, int bandNamesLength)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setBandNames", "([Ljava/lang/String;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setCopyMetadata(SubsetOp _this, boolean copyMetadata)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setCopyMetadata", "(Z)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    (*jenv)->CallVoidMethod(jenv, _this, _method, copyMetadata);
}
...
Rectangle SubsetOp_getRegion(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getRegion", "()Ljava/awt/Rectangle;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setRegion(SubsetOp _this, Rectangle region)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setRegion", "(Ljava/awt/Rectangle;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setSubSamplingX(SubsetOp _this, int subSamplingX)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setSubSamplingX", "(I)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    (*jenv)->CallVoidMethod(jenv, _this, _method, subSamplingX);
}
...
void SubsetOp_setSubSamplingY(SubsetOp _this, int subSamplingY)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setSubSamplingY", "(I)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    (*jenv)->CallVoidMethod(jenv, _this, _method, subSamplingY);
}
...
Geometry SubsetOp_getGeoRegion(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getGeoRegion", "()Lcom/vividsolutions/jts/geom/Geometry;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setGeoRegion(SubsetOp _this, Geometry geoRegion)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setGeoRegion", "(Lcom/vividsolutions/jts/geom/Geometry;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    (*jenv)->CallVoidMethod(jenv, _this, _method, geoRegion);
}
...
void SubsetOp_update(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "update", "()V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_dispose(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "dispose", "()V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
char* SubsetOp_getId(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getId", "()Ljava/lang/String;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
Product* SubsetOp_getSourceProducts(SubsetOp _this, int* _resultArrayLength)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getSourceProducts", "()[Lorg/esa/beam/framework/datamodel/Product;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setSourceProducts(SubsetOp _this, const Product productsElems, int productsLength)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setSourceProducts", "([Lorg/esa/beam/framework/datamodel/Product;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    productsArray = beam_newJObjectArray(productsElems, productsLength, classProduct);
    (*jenv)->CallVoidMethod(jenv, _this, _method, productsArray);
    (*jenv)->DeleteLocalRef(jenv, productsArray);
}
...
Product SubsetOp_getSourceProduct(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getSourceProduct", "()Lorg/esa/beam/framework/datamodel/Product;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setSourceProduct(SubsetOp _this, Product sourceProduct)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setSourceProduct", "(Lorg/esa/beam/framework/datamodel/Product;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    (*jenv)->CallVoidMethod(jenv, _this, _method, sourceProduct);
}
...
Product SubsetOp_getSourceProductById(SubsetOp _this, const char* id)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getSourceProduct", "(Ljava/lang/String;)Lorg/esa/beam/framework/datamodel/Product;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setSourceProductById(SubsetOp _this, const char* id, Product product)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setSourceProduct", "(Ljava/lang/String;Lorg/esa/beam/framework/datamodel/Product;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    idString = (*jenv)->NewStringUTF(jenv, id);
    (*jenv)->CallVoidMethod(jenv, _this, _method, idString, product);
    (*jenv)->DeleteLocalRef(jenv, idString);
}
...
char* SubsetOp_getSourceProductId(SubsetOp _this, Product product)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getSourceProductId", "(Lorg/esa/beam/framework/datamodel/Product;)Ljava/lang/String;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
    ...
    _resultString = (*jenv)->CallObjectMethod(jenv, _this, _method, product);
    _result = beam_newCString(_resultString);
    (*jenv)->DeleteLocalRef(jenv, _resultString);
    return _result;
}
...
Product SubsetOp_getTargetProduct(SubsetOp _this)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getTargetProduct", "()Lorg/esa/beam/framework/datamodel/Product;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
Object SubsetOp_getTargetProperty(SubsetOp _this, const char* name)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getTargetProperty", "(Ljava/lang/String;)Ljava/lang/Object;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
Object SubsetOp_getParameter(SubsetOp _this, const char* name)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "getParameter", "(Ljava/lang/String;)Ljava/lang/Object;");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
void SubsetOp_setParameter(SubsetOp _this, const char* name, Object value)
{
    ...
    if (_method == NULL) {
        if (beam_initApi() == 0) {
            _method = (*jenv)->GetMethodID(jenv, classSubsetOp, "setParameter", "(Ljava/lang/String;Ljava/lang/Object;)V");
            if (_method == NULL) {
                /* Set global error */
            }
        }
...
boolean GeoPos_areValid(const GeoPos gepPositionsElems, int gepPositionsLength)
{
    static jmethodID _method = NULL;
    jarray gepPositionsArray = NULL;
    boolean _result = (boolean) 0;
    if (_method == NULL) {
        if (beam_initApi() == 0) {
    ...
    gepPositionsArray = beam_newJObjectArray(gepPositionsElems, gepPositionsLength, classGeoPos);
    _result = (*jenv)->CallStaticBooleanMethod(jenv, classGeoPos, _method, gepPositionsArray);
    (*jenv)->DeleteLocalRef(jenv, gepPositionsArray);
    return _result;
}
