 ...
 * File created at Thu Nov 08 21:16:16 CET 2012 using org.esa.beam.extapi.gen.ApiGeneratorDoclet
 */
...
Band Product_addEmptyBand(Product _self, const char* bandName, int dataType)
{
    static jmethodID _method = NULL;
...
AngularDirection AngularDirection_newAngularDirection()
{
    static jmethodID _method = NULL;
...
AngularDirection AngularDirection_newAngularDirectionAZ(double azimuth, double zenith)
{
    static jmethodID _method = NULL;
    AngularDirection _result = (AngularDirection) 0;
